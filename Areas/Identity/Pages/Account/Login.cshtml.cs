...
namespace Social.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<SocialUser> signInManager, 
            ILogger<LoginModel> logger,
            UserManager<SocialUser> userManager,
            SocialIDContext idContext)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var newLogIn = new LogIn { UserID = userHandler.getUserByEmail(Input.Email).Id, LoginDate = DateTime.Now };
                    _idContext.Add(newLogIn);
